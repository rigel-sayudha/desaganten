...
@include('partials.breadcrumbs', ['items' => $breadcrumbs])
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
        <a href="{{ route('surat.ktp') }}" class="block bg-blue-50 hover:bg-blue-100 border border-blue-200 rounded-lg p-6 shadow text-center transition">
        ...
        <a href="{{ route('surat.kk') }}" class="block bg-indigo-50 hover:bg-indigo-100 border border-indigo-200 rounded-lg p-6 shadow text-center transition">
        ...
        <a href="{{ route('surat.skck') }}" class="block bg-yellow-50 hover:bg-yellow-100 border border-yellow-200 rounded-lg p-6 shadow text-center transition">
        ...
        <a href="{{ route('surat.kematian') }}" class="block bg-gray-50 hover:bg-gray-100 border border-gray-200 rounded-lg p-6 shadow text-center transition">
        ...
        <a href="{{ route('surat.kelahiran') }}" class="block bg-cyan-50 hover:bg-cyan-100 border border-cyan-200 rounded-lg p-6 shadow text-center transition">
        ...
        <a href="{{ route('surat.usaha') }}" class="block bg-orange-50 hover:bg-orange-100 border border-orange-200 rounded-lg p-6 shadow text-center transition">
