...
@section('content')
    ...
    @endphp
    <section id="hero" class="relative h-[60vh] sm:h-[70vh] md:h-[80vh] flex items-center justify-center overflow-hidden" x-data='{
        slides: [
            { img: "{{ $hero1 }}", title: "Selamat Datang di Desa Ganten", subtitle: "Website Resmi Pemerintah Desa Ganten, Kecamatan Kerjo, Kabupaten Karanganyar" },
            { img: "{{ $hero2 }}", title: "Maju, Mandiri, Sejahtera", subtitle: "Bersama membangun desa yang lebih baik" },
            { img: "{{ $hero3 }}", title: "Alam & Budaya", subtitle: "Keindahan alam dan kearifan lokal Desa Ganten" }
        ],
        active: 0,
        interval: null,
    ...
    <section id="profil" class="py-10 sm:py-16 bg-gray-50">
        <div class="max-w-7xl mx-auto px-2 sm:px-4 grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 items-center">
            ...
            <div>
                ...
                <p class="mb-2 sm:mb-4 italic text-gray-700 text-sm sm:text-base">"Terwujudnya Desa Ganten yang Maju, Mandiri, dan Sejahtera Berlandaskan Gotong Royong dan Kearifan Lokal"</p>
        ...
        <div class="max-w-7xl mx-auto px-2 sm:px-4">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8">
                <div class="text-center">
                    <img src="{{ asset('img/kades.jpg') }}" alt="Kepala Desa" class="w-20 h-20 sm:w-32 sm:h-32 rounded-full mx-auto mb-2 sm:mb-4 object-cover shadow-lg">
                    <h3 class="font-semibold text-base sm:text-lg">Bapak Suharto</h3>
                    <p class="text-gray-600 text-xs sm:text-base">Kepala Desa</p>
                </div>
                <div class="text-center">
                    <img src="{{ asset('img/sekdes.jpg') }}" alt="Sekretaris Desa" class="w-20 h-20 sm:w-32 sm:h-32 rounded-full mx-auto mb-2 sm:mb-4 object-cover shadow-lg">
                    <h3 class="font-semibold text-base sm:text-lg">Ibu Siti Aminah</h3>
                    <p class="text-gray-600 text-xs sm:text-base">Sekretaris Desa</p>
                </div>
                <div class="text-center">
                    <img src="{{ asset('img/kaur.jpg') }}" alt="Kaur" class="w-20 h-20 sm:w-32 sm:h-32 rounded-full mx-auto mb-2 sm:mb-4 object-cover shadow-lg">
                    <h3 class="font-semibold text-base sm:text-lg">Bapak Slamet</h3>
                    <p class="text-gray-600 text-xs sm:text-base">Kaur Pemerintahan</p>
                </div>
                <div class="text-center">
                    <img src="{{ asset('img/kasi.jpg') }}" alt="Kasi" class="w-20 h-20 sm:w-32 sm:h-32 rounded-full mx-auto mb-2 sm:mb-4 object-cover shadow-lg">
                    <h3 class="font-semibold text-base sm:text-lg">Ibu Dewi</h3>
        ...
        <div class="max-w-7xl mx-auto px-2 sm:px-4">
          <h2 class="text-2xl sm:text-3xl font-bold text-center mb-6 sm:mb-12 text-[#0088cc]">Layanan Desa</h2>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-8">
                ...
                <div class="bg-[#0088cc] text-white p-4 sm:p-8 rounded-lg shadow-lg text-center hover:scale-105 transition">
                    <div class="text-3xl sm:text-5xl mb-2 sm:mb-4">🗂️</div>
                    <h3 class="text-base sm:text-xl font-semibold mb-2 sm:mb-4">Laporan Bulanan</h3>
                    <p class="mb-2 sm:mb-4 text-xs sm:text-base">Akses laporan kegiatan dan keuangan desa setiap bulan.</p>
                    <a href="/laporan" class="inline-block bg-white text-[#0088cc] px-4 sm:px-6 py-1.5 sm:py-2 rounded-lg font-bold hover:bg-gray-100 transition text-xs sm:text-base">Lihat Laporan</a>
                </div>
            </div>
        </div>
    </section>
