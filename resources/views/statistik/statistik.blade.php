...
@section('content')
        ...
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                <h1 class="text-3xl md:text-4xl font-bold text-[#0088cc] mb-4 md:mb-0 text-center md:text-left">
                    Statistik Penduduk Desa Ganten
                </h1>
                <!-- Breadcrumbs -->
                <nav class="flex items-center space-x-2 text-sm bg-white rounded-lg shadow px-4 py-2" aria-label="Breadcrumb">
                    ...
                    <span class="text-gray-500 font-semibold">Statistik Penduduk</span>
                </nav>
            </div>
            ...
            <div class="flex flex-col lg:flex-row gap-6">
                    ...
                    <div id="sidebarMenu" class="bg-white rounded-lg shadow-lg hidden lg:block">
                        ...
                        <div>
                            ...
                            <div class="py-2">
                                ...
                                <a href="#pekerjaan-section" class="sidebar-menu-item block px-4 py-2 text-gray-700 hover:bg-gray-100 hover:text-[#0088cc] transition-colors border-l-4 border-[#0088cc] bg-gray-100 text-[#0088cc] font-medium">
                ...
                <div class="lg:w-3/4">
                    ...
                    <!-- Chart Section - Pekerjaan -->
                    <div id="pekerjaan-section" class="bg-white rounded-lg shadow-lg p-6 mb-8">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <!-- Tabel Kelompok Umur -->
                        <div id="umur-section" class="bg-white rounded-lg shadow-lg">
                        ...
                        <!-- Tabel Pendidikan -->
                        <div id="pendidikan-section" class="bg-white rounded-lg shadow-lg">
                            <div class="px-6 py-4 border-b border-gray-200">
                                <h3 class="text-lg font-bold text-gray-900">
    ...
    <script>
        ...
        function showChart(type) {
            ...
            // Create new chart
            pekerjaanChart = new Chart(ctx, config);
        }
        ...
        window.addEventListener('scroll', function() {
            const sections = ['pekerjaan-section', 'umur-section', 'pendidikan-section'];
            let current = '';
            ...
            document.querySelectorAll('.sidebar-menu-item').forEach(item => {
                item.classList.remove('border-[#0088cc]', 'bg-gray-100', 'text-[#0088cc]', 'font-medium');
            ...
            if (current) {
                ...
                if (activeLink) {
                    activeLink.classList.add('border-[#0088cc]', 'bg-gray-100', 'text-[#0088cc]', 'font-medium');
