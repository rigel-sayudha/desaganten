...
<body>
    <div class="kop-surat">
        <div class="logo">
            <img src="{{ public_path('img/logo-karanganyar.png') }}" alt="Logo Desa Ganten" style="width: 45px; height: 45px;">
        </div>
        <div class="kop-text">
    ...
    <div class="content">
        ...
        <table class="data-table">
            <tr>
                <td>Nama Lengkap</td>
                <td>:</td>
                <td><strong>{{ strtoupper($surat->nama_anak ?? $surat->nama ?? '-') }}</strong></td>
            </tr>
            <tr>
                <td>Jenis Kelamin</td>
                <td>:</td>
                <td>{{ $surat->jenis_kelamin_anak ?? $surat->jenis_kelamin ?? '-' }}</td>
            </tr>
            <tr>
                <td>Tempat Lahir</td>
                <td>:</td>
            ...
            <tr>
                <td>Tanggal Lahir</td>
                <td>:</td>
                <td>{{ isset($surat->tanggal_lahir_anak) ? \Carbon\Carbon::parse($surat->tanggal_lahir_anak)->format('d F Y') : (isset($surat->tanggal_lahir) ? \Carbon\Carbon::parse($surat->tanggal_lahir)->format('d F Y') : '-') }}</td>
            </tr>
            <tr>
                <td>Jam Lahir</td>
                <td>:</td>
                <td>{{ $surat->jam_lahir ?? '-' }} WIB</td>
            </tr>
            <tr>
                <td>Berat Badan</td>
                <td>:</td>
        ...
        <table class="data-table">
            ...
            <tr>
                ...
                <td>:</td>
                <td>{{ $surat->tempat_lahir_ayah ?? '-' }}, {{ isset($surat->tanggal_lahir_ayah) ? \Carbon\Carbon::parse($surat->tanggal_lahir_ayah)->format('d F Y') : '-' }}</td>
            </tr>
            <tr>
                <td>Pekerjaan</td>
                <td>:</td>
            ...
            <tr>
                <td>Tempat/Tanggal Lahir</td>
                <td>:</td>
                <td>{{ $surat->tempat_lahir_ibu ?? '-' }}, {{ isset($surat->tanggal_lahir_ibu) ? \Carbon\Carbon::parse($surat->tanggal_lahir_ibu)->format('d F Y') : '-' }}</td>
            </tr>
            <tr>
                <td>Pekerjaan</td>
                <td>:</td>
            ...
            <tr>
                <td>Alamat</td>
                <td>:</td>
                <td>{{ $surat->alamat_orang_tua ?? $surat->alamat ?? '-' }}</td>
            </tr>
        </table>
