...
<body>
    ...
    <div class="nomor">
        Nomor: {{ sprintf('%03d', $surat->id) }}/SKD/{{ date('Y') }}
    </div>
    ...
    <div class="content">
        ...
        <p>Adalah benar-benar penduduk dan berdomisili di wilayah Desa Ganten, Kecamatan Gondangrejo, Kabupaten Karanganyar, Provinsi Jawa Tengah.</p>
