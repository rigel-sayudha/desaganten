...
<body>
    ...
    <div class="nomor">
        Nomor: {{ sprintf('%03d', $surat->id) }}/SKTM/{{ date('Y') }}
    </div>
    ...
    <div class="content">
        ...
        <table class="data-table">
            ...
            <tr>
                ...
                <td class="separator">:</td>
                <td>{{ ucfirst($surat->status_perkawinan) }}</td>
            </tr>
            <tr>
            ...
            @if($surat->penghasilan_per_bulan)
            <tr>
                <td class="label">Penghasilan per Bulan</td>
                <td class="separator">:</td>
                <td>Rp {{ number_format($surat->penghasilan_per_bulan, 0, ',', '.') }}</td>
            </tr>
            @endif
            @if($surat->jumlah_tanggungan)
            <tr>
                <td class="label">Jumlah Tanggungan</td>
                <td class="separator">:</td>
                <td>{{ $surat->jumlah_tanggungan }} orang</td>
            </tr>
            @endif
        </table>

        <p>Adalah benar-benar penduduk Desa Ganten, Kecamatan Gondangrejo, Kabupaten Karanganyar, yang bersangkutan adalah termasuk keluarga <strong>TIDAK MAMPU/KURANG MAMPU</strong> secara ekonomi.</p>

        <p>Hal tersebut berdasarkan pengamatan dan keterangan yang dapat dipertanggungjawabkan kebenarannya.</p>

        <p>Surat keterangan ini dibuat untuk {{ $surat->keperluan ?? 'keperluan yang bersangkutan' }} dan dapat dipergunakan sebagaimana mestinya.</p>

        <p>Demikian surat keterangan ini dibuat dengan sebenar-benarnya.</p>
    </div>
