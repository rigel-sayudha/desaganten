...
<head>
    <meta charset="utf-8">
    <title>Surat Keterangan KK</title>
    <style>
        @page {
            size: A4;
            margin: 1.5cm 2cm;
...
<body>
    ...
    <div class="nomor-surat">
        Surat Keterangan Belum Memiliki Kartu Keluarga<br>
    ...
    <div class="content">
        ...
        <p>Berdasarkan pernyataan, bahwa yang bersangkutan benar-benar penduduk yang berdomisili di Desa Ganten, Kecamatan Kerjo, Kabupaten Karanganyar dan <strong>BELUM MEMILIKI KARTU KELUARGA (KK)</strong> karena sedang dalam proses pembuatan/hilang/rusak.</p>
