    ...
    <div class="content">
        ...
        <table class="data-table">
            <tr>
                <td>Nama Lengkap</td>
                <td>:</td>
                <td><strong>{{ strtoupper($surat->nama_lengkap ?? $surat->nama ?? '-') }}</strong></td>
            </tr>
            <tr>
                <td>NIK</td>
                <td>:</td>
            ...
            <tr>
                ...
                <td>:</td>
                <td>{{ $surat->tempat_lahir ?? '-' }}, {{ isset($surat->tanggal_lahir) ? \Carbon\Carbon::parse($surat->tanggal_lahir)->format('d F Y') : '-' }}</td>
            </tr>
            <tr>
                <td>Jenis Kelamin</td>
                <td>:</td>
            ...
            <tr>
                ...
                <td>:</td>
                <td>{{ $surat->status_perkawinan ?? $surat->status ?? '-' }}</td>
            </tr>
            <tr>
                <td>Pekerjaan</td>
                <td>:</td>
        ...
        <p>Berdasarkan pernyataan, bahwa yang bersangkutan benar-benar penduduk yang berdomisili di Desa Ganten, Kecamatan Kerjo, Kabupaten Karanganyar, yang berkelakuan baik dan tidak pernah terlibat dalam kegiatan yang dapat mengganggu keamanan dan ketertiban masyarakat serta tidak pernah tersangkut perkara pidana.</p>

        <p>Surat pengantar ini dibuat untuk keperluan pembuatan <strong>Surat Keterangan Catatan Kepolisian (SKCK)</strong> di Kepolisian setempat.</p>
