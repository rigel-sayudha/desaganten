...
$breadcrumbs = [
    ...
    ['label' => 'Surat Pengantar SKCK', 'url' => '#'],
];
@endphp
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="mb-8">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900 mb-2">Verifikasi Surat Pengantar SKCK</h1>
                        <p class="text-gray-600">Detail verifikasi dan tahapan proses surat pengantar SKCK</p>
                    </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                <label class="block text-sm font-medium text-gray-700 mb-1">Keperluan SKCK</label>
                                <div class="p-3 bg-gray-50 rounded-lg border">{{ $surat->keperluan }}</div>
                            </div>
                        </div>

                        <!-- Informasi Tambahan SKCK -->
                        <div class="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                            <h3 class="text-lg font-semibold text-blue-900 mb-2">
                                <i class="fas fa-info-circle mr-2"></i>
                                Informasi Penting SKCK
                            </h3>
                            <ul class="text-sm text-blue-800 space-y-2">
                                <li class="flex items-start">
                                    <i class="fas fa-check-circle mr-2 mt-0.5"></i>
                                    <span>Surat pengantar ini diperlukan untuk mengurus SKCK di Polres setempat</span>
                                </li>
                                <li class="flex items-start">
                                    <i class="fas fa-check-circle mr-2 mt-0.5"></i>
                                    <span>Pemohon harus membawa surat pengantar asli saat mengurus SKCK</span>
                                </li>
                                <li class="flex items-start">
                                    <i class="fas fa-check-circle mr-2 mt-0.5"></i>
                                    <span>Verifikasi kelakuan baik dari lingkungan masyarakat sangat penting</span>
                                </li>
                                <li class="flex items-start">
                                    <i class="fas fa-check-circle mr-2 mt-0.5"></i>
                                    <span>Surat pengantar berlaku 30 hari sejak tanggal penerbitan</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="space-y-6">
                    ...
                    <!-- Verification Stages -->
                    <div class="bg-white rounded-xl shadow-lg p-6">
                        <h2 class="text-xl font-bold text-gray-900 mb-6">Tahapan Verifikasi SKCK</h2>
