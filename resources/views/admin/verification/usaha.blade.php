        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="mb-8">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900 mb-2">Verifikasi Surat Keterangan Usaha</h1>
                        <p class="text-gray-600">Detail verifikasi dan tahapan proses surat keterangan usaha</p>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-6">
                        <div class="flex items-center justify-between mb-6">
                            ...
                            <div class="text-right">
                                <div class="text-3xl font-bold text-green-600">{{ $progress }}%</div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="p-3 bg-green-50 rounded-lg border border-green-200">
                                    <strong class="text-green-800">{{ $surat->nama_usaha }}</strong>
                                </div>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Jenis Usaha</label>
                                <div class="p-3 bg-gray-50 rounded-lg border">{{ $surat->jenis_usaha }}</div>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Bidang Usaha</label>
                                <div class="p-3 bg-gray-50 rounded-lg border">{{ $surat->bidang_usaha }}</div>
                            </div>
                            <div class="md:col-span-2">
                                <label class="block text-sm font-medium text-gray-700 mb-1">Alamat Usaha</label>
                                <div class="p-3 bg-gray-50 rounded-lg border">{{ $surat->alamat_usaha }}</div>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Lama Usaha</label>
                                <div class="p-3 bg-gray-50 rounded-lg border">{{ $surat->lama_usaha }}</div>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Jumlah Karyawan</label>
                                <div class="p-3 bg-gray-50 rounded-lg border">{{ $surat->jumlah_karyawan }} orang</div>
                            </div>
                            <div class="md:col-span-2">
    ...
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div class="mt-3">
            ...
            <div class="mb-4">
                ...
                <textarea id="stageNotes" rows="3" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500" placeholder="Tambahkan catatan untuk tahapan ini..."></textarea>
            </div>
            <div class="flex justify-end gap-3">
                <button onclick="closeModal()" class="px-4 py-2 bg-gray-300 text-gray-700 rounded-md hover:bg-gray-400 transition">
                    Batal
                </button>
                <button id="confirmButton" onclick="confirmUpdate()" class="px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition">
                    Update
                </button>
            </div>
        </div>
...
function confirmUpdate() {
    ...
    fetch(`/admin/verification/usaha/{{ $surat->id }}/stage/${currentStage}`, {
        method: 'POST',
        headers: {
