    ...
    <main class="lg:ml-64 pt-14 sm:pt-16 transition-all duration-300" :class="{'lg:ml-16': $store.sidebar?.isMinimized}">
        <div class="p-4 sm:p-6 lg:p-8">
            ...
            <div class="flex items-center justify-between mb-6 sm:mb-8">
                <div>
                    <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Verifikasi Surat Keterangan Belum Menikah</h1>
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-6">
                        <div class="flex items-center justify-between mb-6">
                            ...
                            <div class="text-right">
                                <div class="text-3xl font-bold text-pink-600">{{ $progress }}%</div>
                        ...
                        <div class="w-full bg-gray-200 rounded-full h-3 mb-6">
                            <div class="bg-gradient-to-r from-pink-500 to-rose-600 h-3 rounded-full transition-all duration-500" 
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="text-gray-900">{{ $surat->no_telepon }}</div>
                            </div>
                            @endif
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-6">
                        ...
                        <form onsubmit="addNote(event)">
                            <textarea name="note" 
                                      ...
                                      required></textarea>
                            <button type="submit" 
                                    class="mt-3 w-full px-4 py-2 bg-pink-500 text-white rounded-lg hover:bg-pink-600 transition-colors font-medium">
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-6">
                        ...
                        <div class="space-y-3 max-h-64 overflow-y-auto">
                            @foreach(explode("\n", $surat->catatan_verifikasi) as $note)
                                @if(trim($note))
                                    <div class="p-3 bg-gray-50 rounded-lg border-l-4 border-pink-500">
...
function updateStageStatus(stageNumber, status) {
    ...
    fetch(`/admin/verification/belum_menikah/{{ $surat->id }}/stage/${stageNumber}`, {
        method: 'POST',
        headers: {
...
function addNote(event) {
    ...
    fetch(`/admin/verification/belum_menikah/{{ $surat->id }}/note`, {
        method: 'POST',
        headers: {
            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
        },
