...
<!-- Clean admin layout without Alpine.js -->
<div class="min-h-screen bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <h1 class="font-bold text-lg">Admin Desa Ganten</h1>
                        <p class="text-xs text-blue-200">Sistem Administrasi Desa</p>
                    </div>
                </div>
                <div class="flex items-center space-x-4">
                    <span class="text-sm">Selamat datang, {{ Auth::user()->name ?? 'Admin' }}</span>
                    <form method="POST" action="{{ route('logout') }}" class="inline">
                        @csrf
                        <button type="submit" class="bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded-lg text-sm">
    ...
    <main class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-[#0088cc] mb-2">Pengaturan Surat Keterangan</h1>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6">
            ...
            <form action="{{ route('admin.settings.update') }}" method="POST">
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                    ...
                    <button type="button" onclick="window.location.href='{{ route('admin.dashboard') }}'" class="bg-gray-500 text-white px-6 py-3 rounded-lg hover:bg-gray-600 transition font-semibold text-center">
