...
$breadcrumbs = [
    ...
    ['label' => 'Pelayanan Surat', 'url' => route('admin.surat.index')],
...
@endphp
    ...
    <!-- Simple admin layout without Alpine.js -->
    <div class="flex min-h-screen bg-gray-50 pt-16">
        <!-- Static sidebar -->
        <aside class="fixed top-16 left-0 h-[calc(100vh-4rem)] w-64 bg-white shadow-xl border-r border-gray-200 z-30 hidden lg:block">
            <div class="p-4">
                <h3 class="font-semibold text-gray-800 mb-4">Menu Admin</h3>
                <nav class="space-y-2">
                    <a href="{{ route('admin.dashboard') }}" class="block px-3 py-2 rounded-md text-gray-700 hover:bg-gray-100">Dashboard</a>
                    <a href="{{ url('/admin/surat') }}" class="block px-3 py-2 rounded-md text-gray-700 hover:bg-gray-100">Kelola Surat</a>
                    <a href="{{ url('/admin/settings') }}" class="block px-3 py-2 rounded-md bg-gray-100 text-gray-900">Pengaturan</a>
                </nav>
            </div>
        </aside>

        <main class="flex-1 ml-0 lg:ml-64 pt-8 pb-8 px-4 md:px-8">
            <div class="max-w-7xl mx-auto">
                <div class="mb-8">
                    <h1 class="text-3xl font-bold text-[#0088cc] mb-2 text-center md:text-left">Pengaturan Surat Keterangan</h1>
                ...
                <div class="bg-white rounded-xl shadow-lg p-6">
                    ...
                    <form action="{{ route('admin.settings.update') }}" method="POST">
                        ...
                        <div class="flex flex-col sm:flex-row gap-3">
                            ...
                            <button type="button" onclick="goBack()" class="bg-gray-500 text-white px-6 py-3 rounded-lg hover:bg-gray-600 transition font-semibold text-center">
...
<script>
// Simple navigation function without Alpine.js dependencies
function goBack() {
