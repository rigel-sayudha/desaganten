...
<body>
    ...
    <div class="content">
        <div class="nomor-surat">
            ...
            NOMOR: {{ $surat->nomor_surat ?? 'SKD/001/'.date('m/Y') }}
        </div>
        ...
        <div class="isi-surat">
            Adalah benar-benar penduduk dan berdomisili di Desa {{ $surat->desa ?? 'Kemiri' }}, Kecamatan Gondangrejo, Kabupaten Karanganyar.
        </div>

        <div class="keperluan">
            Keperluan: {{ $surat->keperluan ?? 'Administrasi' }}
        </div>
    ...
    <div class="footer">
        Dicetak pada: {{ date('d F Y H:i:s') }} | Surat Keterangan Domisili
    </div>
</body>
</html>
