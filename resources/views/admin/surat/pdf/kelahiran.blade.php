...
<body>
    ...
    <div class="content">
        <div class="nomor-surat">
            ...
            NOMOR: {{ $surat->nomor_surat ?? 'SKL/001/'.date('m/Y') }}
        </div>
        ...
        <div class="isi-surat">
            Adalah benar telah lahir di Desa {{ $surat->desa ?? 'Kemiri' }}, Kecamatan Gondangrejo, Kabupaten Karanganyar.
        </div>

        <div class="keperluan">
            Keperluan: {{ $surat->keperluan ?? 'Pembuatan Akta Kelahiran' }}
        </div>
    ...
    <div class="footer">
        Dicetak pada: {{ date('d F Y H:i:s') }} | Surat Keterangan Kelahiran
    </div>
</body>
</html>
