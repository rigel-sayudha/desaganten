...
<body>
    ...
    <div class="content">
        <div class="nomor-surat">
            ...
            NOMOR: {{ $surat->nomor_surat ?? 'SKM/001/'.date('m/Y') }}
        </div>
        ...
        <div class="data-pemohon">
            <table>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>{{ $surat->tanggal_kematian ? date('d F Y', strtotime($surat->tanggal_kematian)) : '-' }}</td>
                </tr>
                <tr>
        ...
        <div class="isi-surat">
            Adalah benar telah meninggal dunia di Desa {{ $surat->desa ?? 'Kemiri' }}, Kecamatan Gondangrejo, Kabupaten Karanganyar.
        </div>

        <div class="keperluan">
            Keperluan: {{ $surat->keperluan ?? 'Administrasi Kematian' }}
        </div>
    ...
    <div class="footer">
        Dicetak pada: {{ date('d F Y H:i:s') }} | Surat Keterangan Kematian
    </div>
</body>
</html>
