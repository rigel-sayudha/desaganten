...
<body>
    ...
    <div class="content">
        <div class="nomor-surat">
            SURAT KETERANGAN CATATAN KEPOLISIAN<br>
            NOMOR: {{ $surat->nomor_surat ?? 'SKCK/001/'.date('m/Y') }}
        </div>
        ...
        <div class="isi-surat">
            Sepanjang yang kami ketahui, yang bersangkutan berkelakuan baik dan tidak pernah terlibat dalam tindakan kriminal atau pelanggaran hukum di wilayah Desa {{ $surat->desa ?? 'Kemiri' }}, Kecamatan Gondangrejo, Kabupaten Karanganyar.
        </div>

        <div class="keperluan">
            Keperluan: {{ $surat->keperluan ?? 'Pembuatan SKCK' }}
        </div>
    ...
    <div class="footer">
        Dicetak pada: {{ date('d F Y H:i:s') }} | Surat Keterangan SKCK
    </div>
</body>
</html>
