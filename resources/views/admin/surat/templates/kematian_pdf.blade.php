    ...
    <body>
        <div class="kop-surat">
            <div class="logo">
                <img src="/img/logo-karanganyar.png" alt="Logo Desa Ganten" style="width: 50px; height: 50px;">
            </div>
            <div class="kop-text">
        ...
        <div class="ttd">
            <div class="ttd-content">
                ...
                <p><strong>@php 
                    try {
                        echo \App\Models\Setting::get('kepala_desa_jabatan', 'Kepala Desa Ganten');
                    } catch(\Exception $e) {
                        echo 'Kepala Desa Ganten';
                    }
                @endphp</strong></p>
                <div class="ttd-space"></div>
                <p><strong><u>@php 
                    try {
                        echo \App\Models\Setting::get('kepala_desa_nama', 'Munadi');
                    } catch(\Exception $e) {
                        echo 'Munadi';
                    }
                @endphp</u></strong></p>
