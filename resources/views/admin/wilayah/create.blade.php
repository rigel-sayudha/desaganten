...
<div class="flex">
    ...
    <main class="flex-1 ml-0 md:ml-64 min-h-screen bg-gray-50 pt-24 px-6">
        <div class="mb-8">
            <h1 class="text-2xl font-bold text-[#0088cc] mb-4">Tambah Data Wilayah</h1>
            <form action="{{ route('admin.wilayah.store') }}" method="POST" class="bg-white rounded-lg shadow-lg p-6 max-w-lg">
                @csrf
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="laki_laki" class="w-full border rounded px-3 py-2" required>
                </div>
                <div class="mb-4">
                    <label class="block font-semibold mb-1">Perempuan</label>
                    <input type="number" name="perempuan" class="w-full border rounded px-3 py-2" required>
                </div>
