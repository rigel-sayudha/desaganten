...
<div class="bg-white rounded-lg shadow-md p-6">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-900">Tambah Data Rekap Surat Keluar</h1>
    ...
    <form action="{{ route('admin.laporan.rekap-surat-keluar.store') }}" method="POST" class="space-y-6">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2">
                ...
                <textarea id="untuk_keperluan" 
                          ...
                          required>{{ old('untuk_keperluan') }}</textarea>
            ...
            <div class="md:col-span-2">
                ...
                <textarea id="keterangan" 
                          ...
                          class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 @error('keterangan') border-red-500 @enderror">{{ old('keterangan') }}</textarea>
                @error('keterangan')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
...
<script>
// Auto generate nomor surat based on tanggal and jenis surat
document.getElementById('tanggal_surat').addEventListener('change', generateNomorSurat);
document.getElementById('jenis_surat').addEventListener('change', generateNomorSurat);
...
function generateNomorSurat() {
    ...
    if (tanggal && jenisSurat && !nomorSuratField.value) {
        ...
        const nomorSurat = `${prefix}/${randomNumber}/${month}/${year}`;
        
        nomorSuratField.value = nomorSurat;
    }
}
</script>
@endsection
