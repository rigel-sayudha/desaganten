...
@endphp
        ...
        >
            ...
            <div class="max-w-7xl mx-auto">
                <div class="mb-8">
                    ...
                    <p class="text-gray-600 text-center md:text-left">Kelola data statistik wilayah penduduk Desa Ganten</p>
                </div>
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center">
            <div>
                <h1 class="text-2xl font-bold text-gray-900 mb-2">Kelola Data Wilayah</h1>
                <p class="text-gray-600">Kelola data statistik wilayah penduduk Desa Ganten</p>
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        ...
        <div class="bg-white rounded-lg shadow-sm p-4 border-l-4 border-blue-500">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-2xl font-bold text-blue-600">{{ number_format($statistics['total_penduduk'] ?? 0, 0, ',', '.') }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-4 border-l-4 border-green-500">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-2xl font-bold text-green-600">{{ number_format($statistics['total_laki_laki'] ?? 0, 0, ',', '.') }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-4 border-l-4 border-pink-500">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-2xl font-bold text-pink-600">{{ number_format($statistics['total_perempuan'] ?? 0, 0, ',', '.') }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-4 border-l-4 border-orange-500">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    <p class="text-sm font-medium text-gray-600">Jumlah Wilayah</p>
                    <p class="text-2xl font-bold text-orange-600">{{ number_format($statistics['total_wilayah'] ?? 0, 0, ',', '.') }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <div class="text-sm text-gray-500">{{ Str::limit($wilayah->keterangan, 50) }}</div>
                            @endif
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                            <span class="px-2 inline-flex text-sm leading-5 font-semibold rounded-full bg-orange-100 text-orange-800">
                                {{ number_format($wilayah->jumlah, 0, ',', '.') }}
                            </span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                            <div class="flex justify-center space-x-2">
                                <a href="{{ route('admin.statistik.wilayah.edit', $wilayah) }}" 
                                   class="text-indigo-600 hover:text-indigo-900 transition-colors">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <form action="{{ route('admin.statistik.wilayah.destroy', $wilayah) }}" 
                                      method="POST" 
                                      class="inline"
                                      onsubmit="return confirm('Apakah Anda yakin ingin menghapus data wilayah {{ $wilayah->nama_wilayah }}?')">
                                    @csrf
                                    @method('DELETE')
        ...
        <div class="text-center py-12">
            ...
            <p class="text-gray-600 mb-6">Mulai dengan menambahkan data wilayah pertama</p>
            <a href="{{ route('admin.statistik.wilayah.create') }}" 
               class="inline-flex items-center px-4 py-2 bg-orange-600 text-white text-sm font-medium rounded-lg hover:bg-orange-700 transition-colors">
                <i class="fas fa-plus mr-2"></i>
                Tambah Data Wilayah
    ...
    <div class="bg-orange-50 border border-orange-200 rounded-lg p-6">
        <div class="flex items-start">
            ...
            <div class="ml-3">
                <h3 class="text-lg font-medium text-orange-900 mb-2">Informasi</h3>
                <div class="text-orange-800 space-y-2">
                    <p>• Data wilayah yang diinput akan otomatis ditampilkan di halaman statistik publik</p>
                    <p>• Total jumlah dihitung otomatis dari jumlah laki-laki + perempuan</p>
                    <p>• Jenis wilayah dapat berupa: Dusun, RT, RW, Kelompok, Lingkungan, Kampung, Blok, dll</p>
                    <p>• Lihat hasil di: <a href="/statistik/wilayah" target="_blank" class="underline">Halaman Statistik Wilayah</a></p>
                </div>
            </div>
        </div>
                </div>
