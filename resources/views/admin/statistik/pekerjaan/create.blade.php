...
@endphp
    ...
    <div id="adminLayout" x-data="{ sidebarMinimized: false }" class="flex min-h-screen bg-gray-50">
        ...
        >
            ...
            <div class="max-w-4xl mx-auto">
                <div class="mb-8">
                    <h1 class="text-3xl font-bold text-[#0088cc] mb-2 text-center md:text-left">Tambah Data Pekerjaan</h1>
                    <p class="text-gray-600 text-center md:text-left">Tambahkan data statistik pekerjaan penduduk baru</p>
                </div>
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center">
            <div>
                <h1 class="text-2xl font-bold text-gray-900 mb-2">Tambah Data Pekerjaan</h1>
                <p class="text-gray-600">Tambahkan data statistik pekerjaan penduduk baru</p>
            </div>
    ...
    <!-- Form Section -->
    <div class="bg-white rounded-lg shadow-sm p-6">
        <form action="{{ route('admin.statistik.pekerjaan.store') }}" method="POST" class="space-y-6">
            @csrf
    ...
    <div class="bg-blue-50 border border-blue-200 rounded-lg p-6">
        <div class="flex items-start">
            ...
            <div class="ml-3">
                <h3 class="text-lg font-medium text-blue-900 mb-2">Tips Pengisian</h3>
                <div class="text-blue-800 space-y-2">
                    <p>• Pastikan nama pekerjaan jelas dan spesifik</p>
                    <p>• Masukkan data yang akurat sesuai dengan kondisi terkini</p>
                    <p>• Total akan dihitung otomatis saat Anda mengisi jumlah laki-laki dan perempuan</p>
                    <p>• Keterangan dapat digunakan untuk informasi tambahan</p>
                </div>
            </div>
        </div>
    </div>
