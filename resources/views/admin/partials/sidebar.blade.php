<!-- Admin Sidebar -->
<aside id="adminSidebar" class="bg-white shadow-lg h-full w-64 fixed top-0 left-0 z-40 pt-0 hidden md:block transition-all duration-300">
    <!-- Logo & Title -->
    <div class="flex flex-col items-center justify-center py-6 border-b">
        ...
        <span class="font-bold text-[#0088cc] text-lg text-center leading-tight">DESA GANTEN</span>
    </div>
    <!-- Expand/Minimize Button -->
    <button id="sidebarToggle" class="absolute -right-4 top-6 bg-[#0088cc] text-white rounded-full w-8 h-8 flex items-center justify-center shadow-md focus:outline-none transition-transform duration-300 z-50" title="Expand/Minimize Sidebar">
    ...
    <div class="flex flex-col h-full pt-4">
        <nav class="flex-1 px-4 py-2 space-y-2" x-data="{ openStat: false, openSurat: false, openLap: false }">
            ...
            <a href="#beranda" class="flex items-center px-4 py-3 rounded-lg text-gray-700 hover:text-[#0088cc] hover:bg-blue-50 transition">
                <i class="fas fa-home mr-3"></i> <span class="sidebar-text">Beranda</span>
            </a>
            ...
            <div class="relative">
                <button @click="openStat = !openStat" class="flex items-center w-full px-4 py-3 rounded-lg text-gray-700 hover:text-[#0088cc] hover:bg-blue-50 transition focus:outline-none">
                    ...
                    <i class="fas fa-chevron-down ml-auto" :class="{'rotate-180': openStat}"></i>
                </button>
            ...
            <div class="relative">
                <button @click="openSurat = !openSurat" class="flex items-center w-full px-4 py-3 rounded-lg text-gray-700 hover:text-[#0088cc] hover:bg-blue-50 transition focus:outline-none">
                    ...
                    <i class="fas fa-chevron-down ml-auto" :class="{'rotate-180': openSurat}"></i>
                </button>
                <div x-show="openSurat" class="ml-8 mt-1 space-y-1" @click.away="openSurat = false" x-cloak>
                    ...
                    <a href="/surat/form" class="block px-4 py-2 rounded-lg text-gray-700 hover:text-[#0088cc] hover:bg-blue-50 transition">Pengisian Surat</a>
                </div>
            </div>
            ...
            <div class="relative">
                <button @click="openLap = !openLap" class="flex items-center w-full px-4 py-3 rounded-lg text-gray-700 hover:text-[#0088cc] hover:bg-blue-50 transition focus:outline-none">
                    ...
                    <i class="fas fa-chevron-down ml-auto" :class="{'rotate-180': openLap}"></i>
                </button>
        ...
        <div class="px-4 pb-6">
            <form method="POST" action="{{ route('admin.logout') }}">
                @csrf
                <button type="submit" class="flex items-center text-sm text-gray-400 hover:text-red-600 transition">
    ...
    toggleBtn.addEventListener('click', () => {
        ...
        if (minimized) {
            ...
            if(navbar) {
                ...
                navbar.classList.remove('md:ml-20');
            }
        }
    });
</script>
