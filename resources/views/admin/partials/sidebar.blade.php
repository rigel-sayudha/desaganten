...
>
    ...
    <div class="relative h-full flex flex-col bg-white">
        ...
        <div class="flex flex-col items-center justify-center border-b border-gray-200" :class="{'py-2': isMinimized && !isMobile, 'py-4 sm:py-6': !isMinimized || isMobile}">
            <div class="bg-gradient-to-br from-[#0088cc] to-blue-600 rounded-full flex items-center justify-center mb-2 sm:mb-3 shadow-lg" :class="{'w-8 h-8': isMinimized && !isMobile, 'w-12 h-12 sm:w-16 sm:h-16': !isMinimized || isMobile}">
                <img src="/img/logo.png" alt="Logo Desa Ganten" class="rounded-full object-cover" :class="{'w-6 h-6': isMinimized && !isMobile, 'w-10 h-10 sm:w-14 sm:h-14': !isMinimized || isMobile}">
            </div>
