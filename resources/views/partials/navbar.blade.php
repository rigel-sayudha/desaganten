        ...
        <div class="flex items-center justify-between h-16 lg:h-20">
            ...
            <div class="flex items-center space-x-3 flex-shrink-0">
                <a href="/" class="flex items-center space-x-3 group">
                    <div class="w-10 h-10 lg:w-12 lg:h-12 bg-white rounded-full flex items-center justify-center shadow-md group-hover:shadow-lg transition-shadow">
                        <img src="/img/logo.png" alt="Logo Desa Ganten" class="w-8 h-8 lg:w-10 lg:h-10 rounded-full object-cover">
                    </div>
