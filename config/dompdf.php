...
return [
    ...
    |
    */
    'show_warnings' => false,   // Disable warnings untuk CSS yang tidak didukung

    'public_path' => base_path('public'),  // Explicitly set the public path

    'temporary_file_path' => storage_path('app/dompdf'),
     ...
     */
    'convert_entities' => true,  // Enable entity conversion for better character support
    ...
    'options' => [
         ...
         * Symbol, ZapfDingbats.
         */
        'font_dir' => storage_path('fonts/pdf-fonts'), // Separate directory for PDF fonts
         ...
         * Note: This directory must exist and be writable by the webserver process.
         */
        'font_cache' => storage_path('fonts/pdf-cache'), // Separate cache directory for better organization
